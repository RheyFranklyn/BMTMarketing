    ...
    <div class="home-div vh-100 vw-100">
        ...
        <div class="sidebar">
            ...
            <a href="{{route('prospects')}}">
                <div class="Prospects input-group mt-1 d-flex align-items-center justify-content-center border rounded">
            ...
            <a href="{{route('insight')}}">
                <div class="Insight input-group mt-2 d-flex align-items-center justify-content-center border rounded">
            ...
            <a href="{{route('guides')}}">
                <div class="Guides input-group mt-2 d-flex align-items-center justify-content-center border rounded">
